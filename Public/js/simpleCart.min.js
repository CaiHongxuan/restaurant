    ...
    var s = "string",
        ...
        C = function(q) {
            ...
            B = {
                ...
                image: function(a, b) {
                    return "<img style='width:155px;height:124px;' src='" +
                        a.get(b.attr) + "'/>"
                },
                input: function(a, b) {
                    return "<input type='text' name='" + b.attr + "s[]" + "' value='" + a.get(b.attr) + "' class='" + x + "_input'/>"
                },
                remove: function(a, b) {
            ...
            b.extend({
                writeCart: function(a) {
                    var d = m.cartStyle.toLowerCase(),
                        ...
                        u = c ? "th" : "th",
                        e = c ? "td" : "td",
                        w = b.$create(d),//.addClass("table invoice-table")
            ...
            b.Item = function(a) {
                function d() {
                    ...
                    0 > c.price && (c.price = 0);
                    k(c.discount, s) && (c.discount = parseFloat(c.discount.replace(b.currency().decimal, ".").replace(/[^0-9\.]+/ig, "")));
                    isNaN(c.discount) && (c.discount = 0);
                    0 > c.discount && (c.discount = 0);
                ...
                g.set = function(a, b) {
                    e(a) || (c[a.toLowerCase()] = b, "discount" !== a.toLowerCase() && "price" !== a.toLowerCase() && "quantity" !== a.toLowerCase() || d());
                    return g
                };
                g.equals = function(a) {
                    for (var b in c)
            ...
            b.Item._ = b.Item.prototype = {
                ...
                discount: function(a) {
                    return e(a) ? parseFloat(this.get("discount", !0).toString().replace(b.currency().symbol, "").replace(b.currency().delimiter, "") || 1) : this.set("discount", parseFloat(a.toString().replace(b.currency().symbol, "").replace(b.currency().delimiter, "")))
                },
                id: function() {
                    return this.get("id", !1)
                },
                total: function() {
                    return this.quantity() * this.price() * this.discount() / 10
                }
            };
            b.extend({
                checkout: function() {
            ...
            b.extendCheckout({
                PayPal: function(a) {
                    ...
                    b.each(function(a, c) {
                        ...
                        d["discount_" + g] = (1 * a.discount()).toFixed(2);
                ...
                GoogleCheckout: function(a) {
                    ...
                    var d = {
                            ...
                            ship_method_discount_1: b.shipping(),
